...
public class FilterByDto implements Serializable {
    ...
    public FilterByDto position(Integer position) {
        this.position = position;
        return this;
    }

    public FilterByDto value(String value) {
        this.value = value;
        return this;
    }

    public FilterByDto query(String query) {
        this.query = query;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FilterByDto)) return false;
        FilterByDto orderByDto = (FilterByDto) o;
